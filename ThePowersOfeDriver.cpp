...
//  Gnu compiler: g++ -c -m64 -Wall -l ThePowersOfeDriver.lis -o ThePowersOfeDriver.o ThePowersOfeDriver.cpp
//  Gnu linker:   g++ -m64 -o ThePowersOfe.out ThePowersOfeDriver.o ThePowersOfe.o debug.o
...
int main(){
  ...
  printf("%s","Welcome to Assignment 3!. \n");
